...
class busukfusariumKT : AppCompatActivity()  {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.act_busukfusarium)

        btn_back_fusarium.setOnClickListener {
            var intent = Intent(this@busukfusariumKT, F_HomeKT::class.java)
